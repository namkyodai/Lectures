...
# it is very difficult to narrate meaningful narrative on this, as it seems the prices keep changed up and down even within a short period, the reason for this is that our data is a mixed data and spread in a long time. Let break it down.
