...
## Tên Các Cột Là Giá Trị, Không Phải là Tên Biến (1)

```{r, echo=FALSE, out.width="90%", fig.cap="", fig.align = 'center'}
knitr::include_graphics("assets/img/pew-raw.png")
```
...
## Tên Các Cột Là Giá Trị, Không Phải là Tên Biến (2)

Bảng xếp hạng âm nhạc Billboard
...
p<-datatable(clean,rownames = FALSE,
             options = list(pageLength = 10,
            columnDefs = list(list(className = 'dt-left', targets = c(1:6)))
            ,autoWidth = TRUE)
             )
p
```
