...
## Loại xe với 3 kết quả định danh: CNG, Diesel, and Petrol
v1=rep(1,length(df$FuelType))

v2=rep(0,length(df$FuelType))

df$FuelType1=ifelse(df$FuelType=="CNG",v1,v2) #trả lại giá trị cho biến CNG là v1, và không phải thế là 0
